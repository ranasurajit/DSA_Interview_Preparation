...
<p><span style="font-size: 18px;"><strong>Note</strong>: Initially all are the parent of themselves.</span><span style="font-family: 'Google Sans', Roboto, 'Helvetica Neue', Arial, sans-serif; font-size: 18px;">The ultimate parent is the topmost node such that par[node]=node.</span></p>
